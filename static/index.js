...
let _close = false;
let _fsj = false;
var url = 'https://kbcrt.github.io/EatLeiQionghui/static/image/ClickBefore.png';
...
function shareText(score) {
    ...
    if (score <= 5 * __Time) return '^_^ 加把劲，这样雷琼慧就不会说大可爱了！';
    if (score <= 7.5 * __Time) return '您';
    if (score <= 10 * __Time) return '雷琼慧跪在你的面前';
    return '外星人？';
}
